...
function Home() {
    ...
    return (
        <div>
            <Header />
            <div className="card m-6"><br /><br /><br />
            ...
            <AnimationOnScroll animateIn="animate__fadeIn">
                <div>
                    <div className="has-text-centered p-5 mb-0" >
                        <div className="p-4 ml-6 mb-6 is-size-2 has-text-centered text-underlined-purple">{t('about_me')}<strong className="text-color-purple-light">.</strong></div>
                        <div className="p-4 ml-6 is-size-5">{t('desc_years')}<strong className="has-text-purple">{t('epitech')}</strong><strong className="has-text-purple">part-time</strong>{t('number_days')}<strong className="has-text-purple">{t('days')}</strong>{t('possiblities')}<strong className="has-text-purple">{t('end')}</strong></div>
                    </div>
                </div>
                <div className="has-text-centered p-5">
                    <div className="p-4 ml-6 mb-6 is-size-2 has-text-centered text-underlined-purple">{t('skills')}<strong className="text-color-purple-light">.</strong></div>
